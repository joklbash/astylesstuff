...
public class ItemSwiftShot extends Item
{
	...
	public ItemSwiftShot()
	{
        this.maxStackSize = 1;
		setMaxDamage(700);
		setUnlocalizedName("astylesstuff.swiftshot");
		setCreativeTab(AStylesStuff.itemTab);
		iconString = AStylesStuff.modID + ":swiftshot";
	}
	...
	{
	    par1.addEnchantment(Enchantment.flame, 2);
	    par1.addEnchantment(Enchantment.power, 5);    	
	    par1.addEnchantment(Enchantment.punch, 2);    	
	    par1.addEnchantment(Enchantment.infinity, 1);    	
	}
