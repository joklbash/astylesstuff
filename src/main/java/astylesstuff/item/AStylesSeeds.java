...
public class AStylesSeeds extends ItemSeeds
{
    public String[] textureNames = new String[] { "dye"};
    public IIcon[] icons;

    public Block blockType;

    public AStylesSeeds(Block cropID, Block soilID)
    {
        super(cropID, soilID);
        blockType = cropID;
    ...
    public void registerIcons (IIconRegister iconRegister)
    {
        ...
        {
            this.icons[i] = iconRegister.registerIcon(AStylesStuff.modID + ":" + textureNames[i] + "_seeds");
        }
    }
    ...
    public void addInformation (ItemStack stack, EntityPlayer player, List list, boolean par4)
    {
        ...
        {
        case 0:
            list.add(StatCollector.translateToLocal("tooltip.dye.seed"));
            break;
        }
    }
}
